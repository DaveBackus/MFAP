%  hw2_s12 
%  Matlab program for Lab Report #2, Spring 2012 
...
disp(' ')
disp('------------------------------------------------------------------')
disp('Question 1 (lognormal risks)') 
syms s kappa_1 kappa_2 alpha 

cgf_x = kappa_1*s + kappa_2*s^2/2 
cgf = cgf_x 
...
% Arrow securities 
disp('Price and return of Arrow securities') 
qA = inv([1 1; 1 1.4])*[1/r1; 1]
rA = 1./qA 
