...
FF_returns = xlsread('FamaFrench_returns.xlsx', 'Sheet1');
...
text(7.5, 0.45, 'black is levels, blue is logs')
...
%print -depsc hw5_q2d.pdf

%% 
disp(' ')
disp('------------------------------------------------------------------')
disp('Question 2 (disaster risk)') 
format compact 
clear all 
