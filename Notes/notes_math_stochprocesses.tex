...
*** clean up practice problems, start simpler

*** Think about recursifying, defining conditional probs
...
*** NB:  two kinds of probs:  conditional on start, conditional on previous
...
\section{Digression: components of variance (skip)}
