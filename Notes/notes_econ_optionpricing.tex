...
\item A put option is a claim to the cash flow $ d_{t+1} = (k - x)^+ $.
...
\item The idea is that options have convex payoffs, so their prices increase with risk.
...
%\attachfile{../Code/Matlab/notes_bsm.m}
%\attachfile{../Code/Matlab/merton.m}
\attachfile{../Code/Matlab/notes_options.m}
